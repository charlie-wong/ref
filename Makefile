...
#
# if you are 64bit, then move all -m32 to -m64, then all things will be fine.
# Have fun, enjoy it !
#############################################################################
...
install:all
	$(INSTALL) -d ${DESTDIR}$(PROG_BIN_DIR) ${DESTDIR}${PROG_SHEETS_DIR} ${DESTDIR}${PREFIX_LINK}
	$(INSTALL) ${BUILD_DIR}/$(PROG_NAME) ${DESTDIR}$(PROG_BIN_DIR)
	${CP} -P ${STATIC_DATA_DIR}/$(PROG_NAME) ${DESTDIR}${PREFIX_LINK}/${PROG_NAME}
